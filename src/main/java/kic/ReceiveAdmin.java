 ...
 * @author gagso
 */
public class ReceiveAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String addDel = (String) request.getParameter("addDel");
...
//            Key userKey = datastore.allocateId(keyFactory.newKey());
            if (addDel.equals("add")) {
                ...
                Query<Entity> query = Query.newEntityQueryBuilder()
                        ...
                        .setFilter(StructuredQuery.CompositeFilter.and(
                                ...
                                StructuredQuery.PropertyFilter.eq("secret", secret),
                                StructuredQuery.PropertyFilter.eq("role", role)))
                        .build();
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReceiveAdmin</title>");
            out.println("</head>");
            out.println("<body>");
